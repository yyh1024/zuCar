#pragma checksum "D:\物联网\实训\Car\MvcCroe\MvcCroe\Views\Admins\OrderShow.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "691f660042df98721b7f721d1c4ee7cc1492a39f"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"691f660042df98721b7f721d1c4ee7cc1492a39f", @"/Views/Admins/OrderShow.cshtml")]
    ...
    function Show2() {
        $.ajax({
            ...
            WriteLiteral(@""" : ""取消订单"")) + '</td>'
                            + '<td>' + (this.Hitch == 1 ? ""暂无问题"" : (this.Hitch == 2 ? ""故障申请"" : (this.Hitch == 3 ? ""报修通过"" : ""有待商议"")))
                            + '</td>'
                            + '</tr>';
                        $(""#tb"").append(line);
                    })
